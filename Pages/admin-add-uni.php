...
if ( isset( $_POST['submit'] ) ) {
	...
	if (!$error) {
        ...
        if ($result) {
            echo "<div class='alert alert-success mt-3' role='alert'>Успешно добавен университет!</div>";
        } else {
            echo "<div class='alert alert-danger mt-3' role='alert'>Грешка при добавянето на университета</div>";
        }
    }

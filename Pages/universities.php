                ...
                <div class="col">
                    <div class="card border-primary">
                        <div class="row card-body">
                            ...
                            <form action="university.php?uni=1" method="POST" class="form-inline input-group uni-search align-right">
                                    <input type="hidden" name="uni_id" value="1">
                                    <input type="submit" value="Виж повече" class="btn btn-primary input-group-addon" style="border-radius: 5px !important;text-align:end;">
                                </form>
                            </div>                 
                    </div>
                </div>
